...
@section('second-header')
    <section style="background-image:url({{ asset('assets/frontend/pic/members/banner2.jpg')}});" class="breadcrumbs">
        <div class="container">
            <div class="text-center breadcrumbs-item " >
                <h1 style="color: #E0F2F1">East Africa</h1>
                <h4 style="color: #E0F2F1"> East African Member States</h4>
            </div>
        </div>
    </section>
@endsection
