...
@section('second-header')
    <section style="background-image:url({{ asset('assets/frontend/pic/members/banner3.jpg')}});" class="breadcrumbs">
        <div class="container">
            <div class="text-center breadcrumbs-item " >
                <h1 style="color: #E0F2F1">North Africa</h1>
                <h4 style="color: #E0F2F1">North African Member States</h4>
            </div>
        </div>
    </section>
@endsection
        ...
        <div class="row cws-multi-col">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="portfolio-item text-center">
                    <!-- media-->
                    <div class="pic"><img src="{{ asset('assets/frontend/pic/members/'.$index.'.jpg') }}" data-at2x="{{ asset('assets/frontend/pic/members/'.$index.'.jpg') }}" alt>
                        <!-- item content -->
