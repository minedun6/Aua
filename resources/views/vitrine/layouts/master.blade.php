...
<header>
    ...
    <nav class="main-nav js-stick">
        <div class="full-wrapper relative clearfix container">
            ...
            <div class="nav-logo-wrap local-scroll"><a href="{{ url('/') }}" class="logo"><img src="{{ asset('assets/frontend/img/7bitri.png') }}" data-at2x="img/logo@2x.png" alt><img src="{{ asset('assets/frontend/img/7bitri.png') }}" alt class="sticky-logo"></a></div>
            <!-- Main Menu-->
            <div class="inner-nav desktop-nav switch-menu">
                <ul class="clearlist">
                    ...
                    <!-- End Item With Sub-->
                    <!-- Item With Sub-->
                    <li class="megamenu"><a href="#about_us" class="mn-has-sub">About</a>
                    </li>
                    <!-- End Item With Sub-->
                    <!-- Item With Sub-->
                    <li><a href="#" class="mn-has-sub">Our members <i class="fa fa-angle-down button_open"></i></a>
                        <!-- Sub-->
                        <ul class="mn-sub">
                            <li><a href="{{ url('/members/southAfrica') }}">South africa</a></li>
                            <li><a href="{{ url('/members/westAfrica') }}">West africa</a></li>
                    ...
                    <!-- End Item With Sub-->
                    <!-- Item With Sub-->
                    <li><a href="#activities" class="mn-has-sub">Activities</a>

                    </li>
                    <!-- End Item With Sub-->
                    <!-- Item With Sub-->
                    <li><a href="#contact" class="mn-has-sub">Contact</a>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 text-right"><a href="#" class="footer-nav">Home</a><a href="#about_us" class="footer-nav">About us</a><a href="#activities" class="footer-nav">Our ativities</a><a href="#contact" class="footer-nav">Contact us</a></div>
            </div>
        </div>
    </div>
    <!-- end copyright-->
    ...
    <div class="login-popup-wrap">
        ...
        <div class="login-content">
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                  {{ Form::input('email', 'email', null, ['class' => 'form-row form-row-first', 'placeholder' => trans('validation.attributes.frontend.email')]) }}
              </div><!--col-md-6-->
          </div><!--form-group-->
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                  {{ Form::input('password', 'password', null, ['class' => 'form-row form-row-last', 'placeholder' => trans('validation.attributes.frontend.password')]) }}
              </div><!--col-md-6-->
          </div><!--form-group-->
...
<div class="login-popup" id="video-popup">
    <div class="login-popup-wrap" style="width: 50%;height: auto;">
        <div class="title-wrap">
            <h2></h2><i class="close-button flaticon-cross"></i>
        </div>
        <div class="login-content">


            <video loop autoplay src="{{ asset('videos/test.mp4') }}"  height="400" style="margin: 0 auto" id="vid"></video>
